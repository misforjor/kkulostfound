...
export default function MyPosts() {
  ...
  const [filterType, setFilterType] =
    useState<PostType | 'ทั้งหมด'>('ทั้งหมด');

  const [filterStatus, setFilterStatus] =
    useState<'กำลังดำเนินการ' | 'เสร็จสิ้น' | 'ทั้งหมด'>('ทั้งหมด');
    ...
    return (
      <div className="max-w-3xl mx-auto px-4 py-16 text-center">
        <p className="text-xl font-semibold text-gray-700 mb-4">
          กรุณาเข้าสู่ระบบเพื่อดูโพสต์ของคุณ
        </p>
            ...
            >
              ...
              <div className="flex gap-0">
                ...
                <div className="flex-1 p-4 min-w-0">
                  ...
                  <p className="font-semibold text-[#1E293B] text-sm truncate mb-0.5">
                    {post.title}
                  </p>
                  ...
                  {deletingId === post.id ? (
                    <div className="flex gap-1">
                      ...
                      <button
                        ...
                        className="flex-1 px-2 py-1.5 bg-red-500 text-white text-xs rounded-lg hover:bg-red-600 transition-colors"
                      >
                        ✓
                      </button>
                      ...
                      <button
                        ...
                        className="flex-1 px-2 py-1.5 border border-gray-200 text-xs rounded-lg hover:bg-gray-50 transition-colors"
                      >
                        ✕
                      </button>
